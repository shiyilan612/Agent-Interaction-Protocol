...
from grpc_service import schema_pb2 as grpc__service_dot_schema__pb2
...
class GatewayServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RegisterTool = channel.unary_unary(
                ...
                request_serializer=grpc__service_dot_schema__pb2.ToolInfo.SerializeToString,
...
def add_GatewayServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RegisterTool': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=grpc__service_dot_schema__pb2.ToolInfo.FromString,
...
class GatewayService(object):
    ...
    def RegisterTool(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc_service.GatewayService/RegisterTool',
            grpc__service_dot_schema__pb2.ToolInfo.SerializeToString,
